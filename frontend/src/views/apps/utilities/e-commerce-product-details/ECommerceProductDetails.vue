                ...
                <b-col cols="12" md="7">
                    ...
                    <div class="ecommerce-details-price d-flex flex-wrap mt-1">
                        ...
                        <ul class="unstyled-list list-inline pl-1 border-left">
                            <li v-for="star in 5" :key="star" class="ratings-list-item mr-25">
                                <feather-icon icon="StarIcon" size="18" :class="[{'fill-current': star <= product.rating}, star <= product.rating ? 'text-warning' : 'text-muted']" />
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="product-color-options">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li v-for="color in product.colorOptions" :key="color" class="d-inline-block" :class="{'selected': selectedColor === color}" @click="selectedColor = color">
...
export default {
    ...
    setup() {
        ...
        const fetchProduct = () => {
            ...
            store.dispatch('app-ecommerce/fetchProduct', {
                    productId
                })
                .then(response => {
